...
class Exercice():
    ...
    def generateExerciceNeg(self, nbMinElement:int = 3, nbMaxElement:int = 5):
    ...
    def generateExercicePos(self, nbMinElement:int = 3, nbMaxElement:int = 5):
        numValues = r.randint(nbMinElement,nbMaxElement)
